...
export function decideSystemPrompt(ruleset) {
    ...
    return [
        ...
        '    walking across a flat empty room, asking a friendly NPC a casual',
        '    question, ordering a drink, idly scanning a non-threatening room),',
        '    set required=false with a one-sentence reason in `justification`.',
        '    Reserve checks for moments where a different roll result would',
        '    meaningfully change the next beat.',
