...
export function narratorSystemPrompt() {
    return [
        ...
        '',
        '# Cadence',
        '- Two to four sentences is a typical beat. Six is the hard maximum.',
        '- Vary sentence length. No two consecutive sentences over 15 words.',
        '- End on a declarative statement. Your last sentence must NOT end with `?` (unless it is quoted dialogue, but you cannot write dialogue — so effectively never).',
        '',
        '# Banned closers',
